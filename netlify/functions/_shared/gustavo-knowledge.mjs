export const CASA_KNOWLEDGE = `
CASA DE SAM — CANONICAL WORKING KNOWLEDGE (SEPTEMBER 2026)

Identity and status
- Casa de SAM means Sãso (Freedom), Alegría (Joy), Morada (Home).
- It is a developing lifelong residential nonprofit community in Paraguay for adults with developmental disabilities who need ongoing daily support and may never live independently.
- Planned opening: March 16, 2035, the day Samuel turns eighteen.
- Current stage: planning, research, relationship-building, governance design, and nonprofit formation.
- Casa de SAM is not yet a registered nonprofit, is not operating programs, is not admitting residents, and is not accepting donations. Never imply otherwise.
- The vision is allowed to evolve. The people who may live there matter more than attachment to any particular plan.

What it is and is not
- A permanent home built around dignity, routine, safety, friendship, choice, calm, and joy.
- Not a hospital, school, work program, behavior project, temporary placement, institution, or charity display.
- Residents do not have to earn belonging through work, independence, classes, compliance, or productivity.
- Core anchors: Protect the residents. Protect the promise. Protect the home.

Roadmap
- 2025–2027: research and foundations; establish the nonprofit; recruit the founding board; develop legal, governance, and financial structures; cultivate professional partnerships; refine the vision.
- 2027–2028: acquire approximately 8–12 contiguous hectares, likely near Paraguarí or the Route 2 corridor.
- 2028–2029: orchard, farm, infrastructure, and main commercial bakery.
- 2030–2034: construct three opening homes and the core campus.
- Late 2034: staffing, training, systems testing, and family transition preparation.
- March 16, 2035: planned opening. Empty homes are preferable to rushed admissions.

Resident promise and rights
- Full acceptance is intended to create a lifelong home. Harder care, illness, aging, family poverty, or the death of a caregiver must not make a resident disposable.
- Safety must never become punishment. Residents remain adults and deserve communication support, privacy, personal space, movement, rest, food dignity, respectful health care, family relationships, faith without coercion, and aging-in-place planning.
- Families remain family, but the shared home belongs to residents. Money or donor status cannot buy different resident treatment or rule changes.
- Admissions policies, eligibility, pricing, licensing, staffing, and clinical details are not finalized. Never promise a place or assess whether someone qualifies.

Governance and money
- Governance is designed to outlast the founder. One governing board; operating-country majority and U.S. minority; defined terms; anti-capture rules; the board governs and staff operate.
- Board service is stewardship, not employment. Paid professional work must remain separate from board control.
- Long-term endowment goal: at least USD 30 million, publicly called the Protect the Promise Fund. Growth-only until that threshold except under extraordinary, heavily reviewed circumstances; a future limited draw such as roughly 3% may then be considered with professional guidance.
- Future local operating reserves should equal about 150% of annual operating expenses.
- Donated funds, endowment funds, restricted gifts, resident-care operations, and business revenue require clear accounting boundaries. Donations protect the mission and do not cover speculative business losses.
- Residents and families are not to carry hidden debt for lifelong care after acceptance.
...
- Tours, photography, media, research, church involvement, internships, events, and donor visits must protect privacy, consent, routine, and resident dignity.
- Residents are never marketing props.

Family guest cottages — concept only
- Current concept: three purpose-designed, three-bedroom, two-bath, single-story cottages for families traveling with a child or adult who has developmental, intellectual, or significant support needs.
- They are not general tourist rentals. They are meant to be a welcoming doorway into Casa de SAM, including low-pressure prospective-resident visits, family visits, and mission-aligned stays.
- Guests would join shared meals and appropriate campus life. A compact snack station supports safe foods, medications, drinks, and reheating; it is not a full kitchen intended to isolate families.
- One bedroom may have enhanced elopement and safety supports. Temporary guest identification and monitoring would be individualized and expire at checkout.
- Optional day-program participation could allow caregivers or siblings time away, but it must be treated as a real care service with intake, staffing, permissions, medication rules, safeguarding, emergency procedures, insurance, and any required Paraguayan licensing.
- Secondary use may include donor weekends, visiting professionals, respite, staff transition, emergency family housing, and invited mission partners, without displacing the primary family purpose.
- Final design, eligibility, rates, licensing, insurance, staffing, and launch date are undecided.

How to help now
- Good current next steps include reading and sharing the vision, following current updates, purchasing the ROI workbook, offering relevant professional expertise, or expressing interest in future governance/board conversations.
- Do not solicit donations because Casa de SAM is not accepting them.
`;
